...
| [ÁNYK és 22HIPAK (2022-es Helyi iparűzési adó)](https://nav.gov.hu/nyomtatvanyok/letoltesek/nyomtatvanykitolto_programok/nyomtatvanykitolto_programok_nav/23HIPAK)                                                                                                      | `nav22hipak-ubuntu-xfce`                                                                | `nav22hipak-ubuntu-kde` | `nav22hipak-ubuntu-mate` |
| [ÁNYK és 23HIPAK (2023-es Helyi iparűzési adó)](https://nav.gov.hu/nyomtatvanyok/letoltesek/nyomtatvanykitolto_programok/nyomtatvanykitolto_programok_nav/22hipak)                                                                                                      | `nav23hipak-ubuntu-xfce`                                                                | `nav23hipak-ubuntu-kde` | `nav23hipak-ubuntu-mate` |
